...
public class ModbusTcpModule : IModule
{
    ...
    public void RegisterTypes(IContainerRegistry containerRegistry)
    {
        ...
        containerRegistry.RegisterForNavigation<ModbusTcpSlaveView, ModbusTcpSlaveViewModel>();//ModbusTcp从站界面 
        ...
        containerRegistry.RegisterForNavigation<MtcpLogView, MtcpLogViewModel>();
    }
}